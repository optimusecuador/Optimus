...
<!-- InstanceBeginEditable name="principal" -->
	<div>
    <h2 style='color:white'>CUENTAS DE ALTA VELOCIDAD</h2>
</div>
<form method="POST">

<select name="mes" required class="boton-azul">
...
$selected = ($mesSeleccionado==$num) ? "selected" : "";
...
<button type="submit" name="exportar" class="boton-azul">Exportar Excel</button>
<?php } ?>
...
<div>
    <h2 style='color:white'>PREVISUALIZACION</h2>
</div>
...
<th align="center">Canton</th>
<th align="center">Parroquia</th>
<th align="center">Nombre Usuario</th>
<th align="center">Direccion</th>
<th align="center">Telefono</th>
<th align="center">N° Usuarios</th>
<th align="center">Portador</th>
<th align="center">Tipo Enlace</th>
<th align="center">Up Link</th>
<th align="center">Down Link</th>
<th align="center">Tipo Cliente</th>
<th align="center">Nivel Compartición</th>
</tr>
...
<td align="center">Cañar</td>
<td align="center"><?= $d['nodo'] ?></td>
<td align="center"><?= $d['nodo'] ?></td>
<td align="center"><?= $d['nombrecliente'] ?></td>
<td align="center"><?php 
	$cedula = $d['cliente'];
	$sqld = "SELECT * from `clientes` WHERE `codigo` LIKE '$cedula'";
	$resultd = mysqli_query($con, $sqld);
	while($crowd = mysqli_fetch_assoc($resultd))
	{	
		echo $crowd['direccion'];
		$telefonod = $crowd['telefono1'];
	}
	?></td>
<td align="center"><?php echo $telefonod?></td>
<td align="center">4</td>
<td align="center">UFINET NEDETEL</td>
<td align="center">FIBRA OPTICA</td>
