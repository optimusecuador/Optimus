...
<div class="panel-dark">
    ...
    <h2 class="clientes-title">CUENTAS DE ALTA VELOCIDAD</h2>

    <form method="POST" class="clientes-form-panel">

        <div class="clientes-field" style="max-width:350px;">

            <label>Mes</label>

            <select name="mes" required class="clientes-input">
        ...
        <div class="cliente-actions">
            ...
            <button type="submit" name="exportar" class="btn-action btn-contrato">
                Exportar Excel
            </button>
