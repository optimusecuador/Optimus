...
<div class="cliente-wrapper">
    <div class="panel-dark">
        <h2 class="clientes-title" style="text-align:center; margin-bottom: 20px;">
            <?php echo htmlspecialchars($accion); ?> DE CUENTAS
        </h2>
        
        <form action="confirmacion_ingreso.php" method="post" name="form1" id="form1" class="clientes-form-panel">
            <div class="clientes-form-grid">
                
                <div class="clientes-field clientes-full">
                    <label>CUENTA Y DOCUMENTO:</label>
                    <div style="display: flex; gap: 10px;">
                        <select name="producto" id="producto" class="clientes-input" style="flex: 2;">
                            <?php while($crow = mysqli_fetch_assoc($result)) { ?>
                                <option value="<?php echo $crow['numero']; ?>">
                                    <?php echo htmlspecialchars($crow['institucion']); ?>
                                </option>
                            <?php } ?>
                        </select>
                        <input type="text" name="documento" required id="documento" class="clientes-input" placeholder="Documento" style="flex: 1;">
                    </div>
                </div>

                <div class="clientes-field">
                    <label>FECHA (Opcional):</label>
                    <input type="date" name="fecha" class="clientes-input">
                    <small style="color: var(--muted);">Si deja en blanco, será la actual</small>
                </div>
            ...
            <div style="margin-top: 25px; text-align: right;">
                <button name="submit2" type="submit" class="btn-action btn-contrato" id="submit2">GUARDAR</button>
            </div>
        </form>
    </div>
</div>
