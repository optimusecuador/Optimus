...
if (isset($_GET['codigo'])) {
    $codigo_safe = mysqli_real_escape_string($con, $_GET['codigo']);
    $sql = "SELECT * from `".$tabla."` WHERE `codigo` LIKE '$codigo_safe' order by fechaing DESC";
    ...
    if($crow = mysqli_fetch_assoc($result)) {	
        ...
        $tipo = $crow['tipo'];
        $preciouno = $crow['preciouno'];
        $preciodos = $crow['preciodos'];
        $preciotres = $crow['preciotres'];
    }
} else {
    $accion = "nuevo";
    $codigo ="";
            ...
            <tbody>
              <tr>
                <td align="center"><div class="esquinas_redondeadas">
                  &nbsp;
                  <h2 id="optimus">REGISTRO DE PRODUCTO<br>
                  </h2>
                </div></td>
              </tr>
              <tr>
                <td align="center"><form action="confirmacion_precio.php" method="post" name="form1" id="form1">
                  <div class="grilla_listado">
                      <table width="95%" align="center" class="clase_tabla">
                        <tbody>
                          <tr>
                            <td colspan="3" align="center"><strong>CODIGO ID : </strong></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><input id="element_1" name="element_1" class="clientes-input" type="text" maxlength="255" value="<?php echo htmlspecialchars($codigo);?>"/></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><strong>NOMBRE DEL PRODUCTO : </strong></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><input id="element_2" name="element_2" class="clientes-input" type="text" maxlength="255" value="<?php echo htmlspecialchars($producto);?>"/></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><strong>VALOR COMPRA (SIN IVA): </strong></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><input id="precio" name="precio" class="clientes-input" type="text" maxlength="255" value="<?php echo htmlspecialchars($precio);?>"/></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><strong>MEGAS:</strong></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><input name="megas" type="text" required="required"  class="clientes-input" id="megas" value="<?php echo htmlspecialchars($megas);?>" maxlength="255"/></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center">&nbsp;</td>
                            </tr>
                          <tr>
                            <td align="center"><strong>PRECIO 1 (SIN IVA): 
                              <input name="preciouno" type="text" class="clientes-input" id="preciouno" value="<?php echo htmlspecialchars($preciouno);?>" size="25" maxlength="25"/>
                              </strong></td>
                            <td align="center"><strong>PRECIO 2 (SIN IVA):
                              <input name="preciodos" type="text" class="clientes-input" id="preciodos" value="<?php echo htmlspecialchars($preciodos);?>" size="25" maxlength="25"/>
                              </strong></td>
                            <td align="center"><strong>PRECIO 3 (SIN IVA):
                              <input name="preciotres" type="text" class="clientes-input" id="preciotres" value="<?php echo htmlspecialchars($preciotres);?>" size="25" maxlength="25"/>
                              </strong></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><input id="accion" name="accion" class="clientes-input" type="text" maxlength="25" value="<?php echo htmlspecialchars($accion);?>" style="visibility:hidden"/></td>
                            </tr>
                          <tr>
                            <td colspan="3" align="center"><p class="buttons">
                              <input id="saveForm" class="boton-azul" type="submit" name="submit" value="Guardar" />
                              </p>
                              <p >&nbsp;</p></td>
                            </tr>
                          </tbody>
