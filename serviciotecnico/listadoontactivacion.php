		...
		{		
				...
				// EJECUTAR COMANDOS DE ACTIVACION DE OLT 
					...
					if ($posicion_coincidencia === false) 
					{
    					if (isset($_GET['codigo'])) 
                	{
						$codigocontrato = $_GET['codigo'];
						$output;
							// saco ytarjeta y puerto
                        $separador = "F/S/P";
                        $separada = explode($separador, $output);
						$cantidadDeclientes = count($separada);	
                        for ($onus = 1; $onus < $cantidadDeclientes; $onus++) 
                        {
						$findme   = 'SN';
						$busqueda = strpos($separada[$onus], $findme);	
						if ($busqueda === false) {
						} 
						else
						{
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    $puertoytarjeta = substr($puertoytarjeta, 1);
                    ...
                    $separada = explode($separador, $separada[$onus]);
                    ...
                    $separada = explode($separador, $serie);
                    ...
                    <form 
                        action="../serviciotecnico/servicio_tecnico_oficina.php?codigo=<?php echo $codigocontrato; ?>&serieont=<?php echo $serie;?>&tarjeta=<?php echo $puertoytarjeta;?>" 
                        method="post"
                        name="form1"
                        id="form1"
                    >
                ...
                <td align="center" style="padding:40px;">
                    ...
                    <div class="cliente-info-header">
                        ...
                        <div class="cliente-info-title">
                            ...
                            NO EXISTE ONT PARA SER ACTIVADA
...
Swal.fire({
    icon: "warning",
    title: "Aviso",
    text: "No existe una OLT para activar. Solo se puede asignar una IP de MikroTik.",
