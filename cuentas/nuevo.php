...
.menu-section a:hover{transform:translateX(6px);background:rgba(0,255,255,.08)}
    ...
    <h2 class="clientes-title">REGISTRO DE CUENTAS</h2>
</div>
...
<div class="cliente-table-panel">
    <form action="confirmacion_nuevo.php" method="post" name="form1" id="form1">
        <table class="table-dark">
            <tbody>
                <tr>
                    <th style="text-align: right; width: 30%;">CODIGO ID:</th>
                    <td>
                        <input id="element_1" 
                               name="element_1" 
                               required 
                ...
                <tr>
                    <th style="text-align: right;">NOMBRE DE LA CUENTA:</th>
                    <td>
                        <input id="element_2" 
                               name="element_2" 
                               required 
                ...
                <tr>
                    ...
                    <td>
                        <select name="responsable" id="responsable" class="clientes-input">
                            <?php 
                            while($crowp = mysqli_fetch_assoc($result2)) {	
                                if($responsable == $crowp['responsable']) {
                                    ?>
                                    <option selected value="<?php echo $crowp['codigo']; ?>">
                                        <?php echo $crowp['nombres'] . " " . $crowp['apellidos']; ?>
                                    </option>
                                    <?php
                                } else {
                                    ?>
                                    <option value="<?php echo $crowp['codigo']; ?>">
                                        <?php echo $crowp['nombres'] . " " . $crowp['apellidos']; ?>
                                    </option>
                                    <?php
                                }
