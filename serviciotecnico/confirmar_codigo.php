...
.menu-section a:hover{transform:translateX(6px);background:rgba(0,255,255,.08)}
    ...
    <h2 class="clientes-title">CONFIRMAR CÓDIGO DE SEGURIDAD</h2>
</div>
...
if (isset($_POST['confirmar'])) 
{
    ...
    $sql4 = "SELECT * from `generar_codigo` WHERE `codigo` LIKE '$codigo' order by fecha ASC";
    ...
    if($codigo_recuperado == $codigo)
    {
        ...
        window.location.href = "agendardelete_task.php";
        </script>
        <?php 
    }
    else
...
<div class="cliente-table-panel">
    <form action="confirmar_codigo.php" method="post" name="form1" id="form1">
        <table class="table-dark">
            <thead>
                <tr>
                    <th style="text-align: center;">POR FAVOR, INGRESE SU CÓDIGO</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="text-align: center; padding: 24px 16px;">
                        <input name="codigo" type="text" id="codigo" class="clientes-input" style="max-width: 320px; margin: 0 auto;" placeholder="Código de verificación">
                ...
                <tr>
                    <td style="text-align: center; padding-bottom: 24px;">
                        <input type="submit" name="confirmar" id="confirmar" value="VERIFICAR CODIGO" class="boton-azul">
                    </td>
                </tr>
            </tbody>
        </table>
