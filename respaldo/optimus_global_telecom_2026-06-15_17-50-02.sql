...
--
-- Host: 127.0.0.1    Database: optimus_global_telecom
-- ------------------------------------------------------
...
CREATE TABLE `acceso` (
  `id` int(11) NOT NULL,
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `url` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `ip` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `mac` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `nombre` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  PRIMARY KEY (`id`)
...
CREATE TABLE `activar_contrato` (
  `contrato` varchar(255) NOT NULL DEFAULT 'vacio',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`unico`)
...
CREATE TABLE `apis` (
  `id` int(11) NOT NULL,
  `numerowhatsapp` varchar(255) NOT NULL DEFAULT 'vacio',
  `tokenwhatsapp` varchar(255) NOT NULL DEFAULT 'vacio',
  `instanciawhatsapp` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `app_cliente` (
  `id` int(11) NOT NULL,
  `cliente` varchar(255) NOT NULL DEFAULT 'vacio',
  `solicitud` varchar(255) NOT NULL DEFAULT 'vacio',
...
CREATE TABLE `asientos` (
  `id` int(11) NOT NULL,
  `asiento` varchar(255) NOT NULL DEFAULT 'vacio',
  `debeuno` varchar(255) NOT NULL DEFAULT 'vacio',
  `debedos` varchar(255) NOT NULL DEFAULT 'vacio',
  `debetres` varchar(255) NOT NULL DEFAULT 'vacio',
  `debecuatro` varchar(255) NOT NULL DEFAULT 'vacio',
  `debecinco` varchar(255) NOT NULL DEFAULT 'vacio',
  `debeseis` varchar(255) NOT NULL DEFAULT 'vacio',
  `haberuno` varchar(255) NOT NULL DEFAULT 'vacio',
  `haberdos` varchar(255) NOT NULL DEFAULT 'vacio',
  `habertres` varchar(255) NOT NULL DEFAULT 'vacio',
  `habercuatro` varchar(255) NOT NULL DEFAULT 'vacio',
  `habercinco` varchar(255) NOT NULL DEFAULT 'vacio',
  `haberseis` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `bodegas` (
  `numero` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `nombre` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `responsable` varchar(255) NOT NULL DEFAULT '0',
  `id` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `tabla` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `principal` varchar(255) NOT NULL DEFAULT 'no',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`unico`)
...
CREATE TABLE `categorias` (
  `id_categoria` varchar(255) NOT NULL DEFAULT 'vacio',
  `nombre_categorias` varchar(255) NOT NULL DEFAULT 'vacio',
  `url_imagen` varchar(255) NOT NULL DEFAULT 'vacio',
...
CREATE TABLE `citasmedicas` (
  `cedula` varchar(255) NOT NULL DEFAULT 'vacio',
  `nombres` varchar(255) NOT NULL DEFAULT 'vacio',
  `correo` varchar(255) NOT NULL DEFAULT 'vacio',
  `telefono` varchar(255) NOT NULL DEFAULT 'vacio',
  `direccion` varchar(255) NOT NULL DEFAULT 'vacio',
  `nombremedico` varchar(255) NOT NULL DEFAULT 'vacio',
  `especialidad` varchar(255) NOT NULL DEFAULT '255',
  `turnos` int(11) NOT NULL,
  `fecha` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`turnos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clienteasignar` (
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `estado` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `bodega` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `novedades` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `prioridad` int(11) NOT NULL DEFAULT 3,
  `lat` varchar(255) NOT NULL DEFAULT '0',
  `lng` varchar(255) NOT NULL DEFAULT '0',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `caja` varchar(255) NOT NULL DEFAULT '0',
  `contrato` varchar(255) NOT NULL DEFAULT '0',
  `armadocaja` varchar(10) NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`)
...
CREATE TABLE `clientegps` (
  ...
  `lat` varchar(255) NOT NULL DEFAULT '0',
  `lng` varchar(255) NOT NULL DEFAULT '0',
  `pais` varchar(255) NOT NULL DEFAULT '0',
  `codigo` varchar(255) NOT NULL DEFAULT '0',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `modelo` varchar(255) NOT NULL DEFAULT '0',
  `serie` varchar(255) NOT NULL DEFAULT '0',
  `contrato` varchar(255) NOT NULL DEFAULT '0',
  `ipgestion` varchar(255) NOT NULL DEFAULT 'vacio',
  `nodo` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clientes` (
  `id` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `nombres` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `apellidos` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `direccion` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `telefono1` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `telefono2` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `mail` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `foto1` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `foto2` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `foto3` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `foto4` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `saldo` int(11) NOT NULL DEFAULT 0,
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `foto5` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `isp` varchar(255) NOT NULL DEFAULT 'no',
  `proveedorisp` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `pct` varchar(255) NOT NULL DEFAULT 'no',
  `procesado` varchar(255) NOT NULL DEFAULT 'no',
  `medio` varchar(255) NOT NULL DEFAULT 'no',
  `fechaprocesado` varchar(255) NOT NULL DEFAULT '0',
  `foto6` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `foto7` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `usuario` varchar(255) NOT NULL DEFAULT '0',
  `contrasena` varchar(255) NOT NULL DEFAULT '0',
  `cedula1` varchar(255) NOT NULL DEFAULT '0',
  `cedula2` varchar(255) NOT NULL DEFAULT '0',
  `planilla` varchar(255) NOT NULL DEFAULT '0',
  `multimedia` varchar(10) NOT NULL DEFAULT 'no',
  `ciudad` varchar(255) NOT NULL DEFAULT '0',
  `representante` varchar(255) NOT NULL DEFAULT 'Sin_Representante',
  `juridica` varchar(255) NOT NULL DEFAULT 'no',
  `fuente` varchar(255) NOT NULL DEFAULT '0',
...
INSERT INTO `clientes` VALUES ('0102917689','0102917689','CARDENAS CAMPOS DANIEL TEODORO','Sin Asignar','Salto a la soga','0992950431','','sin@mail','2026-05-24 (22:24:42)','../images/silueta.gif','../images/silueta.gif','../images/silueta.gif','../images/silueta.gif',0,19,'../images/silueta.gif','NO','SIN ASIGNAR','no','no','no','0','../images/silueta.gif','../images/silueta.gif','daniel teodoro','0102917689','0','0','0','NO','0','CARDENAS CAMPOS DANIEL TEODORO','NO','0','0');
...
CREATE TABLE `compras` (
  ...
  `serie` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `caja` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `propietario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ruc` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `autorizacion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `preciounitario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `preciototal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `subtotal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `iva` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `total` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `vencimiento` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `descuento` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `estado` varchar(255) NOT NULL DEFAULT 'pendiente',
  `forma_pago` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `abono` varchar(255) NOT NULL DEFAULT '0',
  `nombrecliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `recibo` varchar(255) NOT NULL DEFAULT '../images/sin_documento.png',
  `numerorecibo` varchar(255) NOT NULL DEFAULT 'Sin_Recibo',
  `contrato` varchar(255) NOT NULL DEFAULT '0',
  `tipodocumento` varchar(255) NOT NULL DEFAULT 'Sin_documento',
  `foto` varchar(255) NOT NULL DEFAULT 'Sin_Foto',
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `estadodos` varchar(255) NOT NULL DEFAULT 'activo',
  PRIMARY KEY (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `compras_comercialesatemporal` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT 'vacio',
  `description` text DEFAULT NULL,
  `created_at` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `personal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `extra` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `compratemporal` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT 'vacio',
  `description` varchar(255) DEFAULT 'vacio',
  `created_at` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `personal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
...
CREATE TABLE `configuracion` (
  `empresa` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ruc` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `autorizacion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `direccion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `telefono` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `iva` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ice` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `logo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `logoimprecionhojacompleta` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `colorfondo` varchar(255) NOT NULL DEFAULT '0',
  `tipo` varchar(255) NOT NULL DEFAULT 'factura',
  `carpeta` varchar(255) NOT NULL DEFAULT 'sin_carpeta',
  `nombremedico` varchar(255) NOT NULL DEFAULT 'vacio',
  `especialidad` varchar(255) NOT NULL DEFAULT 'vacio',
  `clave` varchar(255) NOT NULL DEFAULT 'vacio',
  `firmaelectronica` varchar(255) NOT NULL DEFAULT '''vacio',
  `ambiente` varchar(10) NOT NULL DEFAULT 'vacio',
  `tipoemision` varchar(10) NOT NULL DEFAULT 'vacio',
  `codigodocumento` varchar(10) NOT NULL DEFAULT 'vacio',
  `establesimiento` varchar(10) NOT NULL DEFAULT 'vacio',
  `contabilidad` varchar(10) NOT NULL DEFAULT 'vacio',
  `configuracion` varchar(255) NOT NULL,
  `web` varchar(255) NOT NULL DEFAULT 'sin_web',
  `representante` varchar(255) NOT NULL DEFAULT 'vacio',
  `leyendafactura` varchar(255) NOT NULL DEFAULT 'vacio',
  `firmasrecibo` varchar(255) NOT NULL DEFAULT 'si',
  `personanatural` varchar(255) NOT NULL DEFAULT 'no',
  `tipoempresa` varchar(255) NOT NULL DEFAULT 'isp',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `actualizacion` varchar(255) NOT NULL DEFAULT '0',
  `reconeccion` varchar(255) NOT NULL DEFAULT '0',
  `olt` varchar(10) NOT NULL DEFAULT 'no',
  `mikrotik` varchar(10) NOT NULL DEFAULT 'no',
  PRIMARY KEY (`unico`)
...
CREATE TABLE `contratos` (
  ...
  `gps1` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `gps2` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `direccion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `telefono` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `router` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `antena` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cable` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `conectores` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `mail` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `estado` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ultima_factura` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `vendedor` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cortado` varchar(255) NOT NULL DEFAULT 'no',
  `procesados` varchar(255) NOT NULL DEFAULT 'si',
  `nombres` varchar(255) NOT NULL DEFAULT 'vacio',
  `nodo` varchar(255) NOT NULL DEFAULT '001',
  `dia_corte` varchar(255) NOT NULL DEFAULT '15',
  `dia_corte_actual` varchar(255) NOT NULL DEFAULT '15',
  `service_port` varchar(255) NOT NULL DEFAULT '0',
  `caja` varchar(255) NOT NULL DEFAULT '0',
  `absoluta` varchar(255) NOT NULL DEFAULT '0',
  `autorizacion` varchar(255) NOT NULL DEFAULT '0',
  `id` varchar(255) NOT NULL DEFAULT '0',
  `puerto` varchar(255) NOT NULL DEFAULT '0',
  `asignado` varchar(255) NOT NULL DEFAULT 'no',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `activado` varchar(255) NOT NULL DEFAULT 'no',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `puerto_gestion` varchar(255) NOT NULL DEFAULT '0',
  `monitoreo` varchar(10) NOT NULL DEFAULT '0',
  `terceraedad` varchar(5) NOT NULL DEFAULT 'no',
  `cedula1` varchar(254) NOT NULL DEFAULT '0',
  `cedula2` varchar(254) NOT NULL DEFAULT '0',
  `planilla` varchar(254) NOT NULL DEFAULT '0',
  `foto1` varchar(255) NOT NULL DEFAULT '../images/sistema/12.png',
  `foto2` varchar(255) NOT NULL DEFAULT '../images/sistema/12.png',
  `foto3` varchar(255) NOT NULL DEFAULT '../images/sistema/12.png',
  `foto4` varchar(255) NOT NULL DEFAULT '../images/sistema/12.png',
  PRIMARY KEY (`unico`)
...
INSERT INTO `contratos` VALUES ('0102917689','Plan2','2026-04-22 (12:00:44)',0,'Sin_Asignar','Sin_Asignar','Control Sur','996629720','Sin_Asignar','Sin_Asignar','Sin_Asignar','Sin_Asignar','Sin_Asignar','activo','Sin_Asignar','Sin_Asignar','no','si','Daiel Teodoro Cardenas Campos','CUENCA','15','15','0','0','0','0','0','0','no','0','si',17,'0','0','si','0','0','0','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png'),('0102917689','Plan5','2026-05-07 (16:54:04)',1,'0','0','Control Sur','996629720-996629720','Sin_Asignar','Sin_Asignar','Sin_Asignar','Sin_Asignar','soldaniela416@gmail.com','activo','Sin_Asignar','6','no','si','Daiel Teodoro','CUENCA','10','01','0','0','666','207807826756350','0','0','no','0','no',18,'0','0','si','0','0','0','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png'),('0102917689','conveniototal','2026-05-26 (21:28:33)',2,'','','Salto a la soga','0996629720','Sin_Asignar','Sin_Asignar','Sin_Asignar','Sin_Asignar','sin@mail','Sin_Asignar','Sin_Asignar','0103597130','no','si','CARDENAS CAMPOS DANIEL TEODORO','CUENCA','10','10','0','0','','0','0','0','no','0','no',24,'0','0','no','1779848913_peinado.jpeg','1779848913_Pou_from_the_Pou_video_game.png','1779848913_sol.jpeg','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png'),('0102917689','conveniototal','2026-06-11 (18:06:07)',3,'','','Salto a la soga','0992950431','Sin_Asignar','Sin_Asignar','Sin_Asignar','Sin_Asignar','sin@mail','Sin_Asignar','Sin_Asignar','0103597130','no','si','CARDENAS CAMPOS DANIEL TEODORO','CUENCA','10','10','0','0','','0','0','0','no','0','no',25,'0','0','si','','','','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png','../images/sistema/12.png');
...
CREATE TABLE `contratoscompra` (
  ...
  `id` varchar(255) NOT NULL DEFAULT '0',
  `puerto` varchar(255) NOT NULL DEFAULT '0',
  `contratos` varchar(255) NOT NULL DEFAULT '0',
  `asignado` varchar(255) NOT NULL DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cuentas` (
  `numero` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `institucion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `saldo` varchar(255) NOT NULL DEFAULT '0',
  `id` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `responsable` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`unico`)
...
CREATE TABLE `cuentascontable` (
  `debe` varchar(255) NOT NULL DEFAULT 'vacio',
  `haber` varchar(255) NOT NULL DEFAULT 'vacio',
  `bgeneral` varchar(255) NOT NULL DEFAULT 'vacio',
  `bresultados` varchar(255) NOT NULL DEFAULT 'vacio',
  `nuno` int(11) NOT NULL DEFAULT 0,
  `ndos` int(11) NOT NULL DEFAULT 0,
  `ntres` int(11) NOT NULL DEFAULT 0,
  `ncuatro` int(11) NOT NULL DEFAULT 0,
  `ncinco` int(11) NOT NULL DEFAULT 0,
  `nseis` int(11) NOT NULL DEFAULT 0,
  `saldo` varchar(255) NOT NULL DEFAULT '0',
  `nombre` varchar(255) NOT NULL DEFAULT 'vacio',
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `diario` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asiento` varchar(255) NOT NULL DEFAULT '0',
  `debeuno` varchar(255) NOT NULL DEFAULT '0',
  `debedos` varchar(255) NOT NULL DEFAULT '0',
  `debetres` varchar(255) NOT NULL DEFAULT '0',
  `debecuatro` varchar(255) NOT NULL DEFAULT '0',
  `debecinco` varchar(255) NOT NULL DEFAULT '0',
  `debeseis` varchar(255) NOT NULL DEFAULT '0',
  `haberuno` varchar(255) NOT NULL DEFAULT '0',
  `haberdos` varchar(255) NOT NULL DEFAULT '0',
  `habertres` varchar(255) NOT NULL DEFAULT '0',
  `habercuatro` varchar(255) NOT NULL DEFAULT '0',
  `habercinco` varchar(255) NOT NULL DEFAULT '0',
  `haberseis` varchar(255) NOT NULL DEFAULT '0',
  `fecha` varchar(255) NOT NULL DEFAULT '0',
  `descripcion` varchar(255) NOT NULL DEFAULT '0',
  `sumadebeuno` varchar(255) NOT NULL DEFAULT '0',
  `sumadebedos` varchar(255) NOT NULL DEFAULT '0',
  `sumadebetres` varchar(255) NOT NULL DEFAULT '0',
  `sumadebecuatro` varchar(255) NOT NULL DEFAULT '0',
  `sumadebecinco` varchar(255) NOT NULL DEFAULT '0',
  `sumadebeseis` varchar(255) NOT NULL DEFAULT '0',
  `sumahaberuno` varchar(255) NOT NULL DEFAULT '0',
  `sumahaberdos` varchar(255) NOT NULL DEFAULT '0',
  `sumahabertres` varchar(255) NOT NULL DEFAULT '0',
  `sumahabercuatro` varchar(255) NOT NULL DEFAULT '0',
  `sumahabercinco` varchar(255) NOT NULL DEFAULT '0',
  `sumahaberseis` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `dispositivos` (
  `id` varchar(255) NOT NULL DEFAULT 'vacio',
  `serie` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `modelo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ip` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `contrato` varchar(255) NOT NULL DEFAULT 'Sin_Asignar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dispositivos_empresa` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) DEFAULT 'vacio',
  `direccion` varchar(100) DEFAULT 'vacio',
  `lat` float NOT NULL,
  `lng` float NOT NULL,
  `pais` varchar(100) DEFAULT 'vacio',
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ip` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `referencial` varchar(50) NOT NULL DEFAULT '0',
  `nodo` varchar(255) NOT NULL DEFAULT '0',
  `tarjeta` varchar(255) NOT NULL DEFAULT '0',
  `tipo` varchar(255) NOT NULL DEFAULT '0',
  `descripcion` varchar(255) NOT NULL DEFAULT '0',
  `ubicacion` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `documento_reservado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `documento` varchar(255) NOT NULL DEFAULT 'vacio',
  `serie` varchar(255) NOT NULL DEFAULT 'vacio',
  `caja` varchar(255) NOT NULL DEFAULT 'vacio',
  `tipo` varchar(255) NOT NULL DEFAULT 'vacio',
  `usuario` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
...
CREATE TABLE `equiposolt` (
  `cliente` varchar(512) NOT NULL DEFAULT '0',
  `contrato` varchar(512) NOT NULL DEFAULT '0',
  `nombre` varchar(512) NOT NULL DEFAULT '0',
  `serie` varchar(255) NOT NULL DEFAULT '0',
  `estado` varchar(255) NOT NULL DEFAULT 'sin_estado',
  `tarjeta` varchar(255) NOT NULL DEFAULT 'sin_tarjeta',
  `tarjetaoriginal` varchar(255) NOT NULL DEFAULT 'sin_tarjeta'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fotostemp` (
  `uno` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `dos` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `tres` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cuatro` varchar(255) NOT NULL DEFAULT 'Sin_Asignar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `generar_codigo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(255) NOT NULL DEFAULT '0',
  `observacion` varchar(255) NOT NULL DEFAULT '0',
  `usuario` varchar(255) NOT NULL DEFAULT '0',
  `fecha` varchar(255) NOT NULL DEFAULT '0',
  `ocupado` varchar(255) NOT NULL DEFAULT 'no',
  `motivousuario` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `google_maps_php_mysql` (
  `id` int(11) NOT NULL,
  `nombre` varchar(255) DEFAULT 'vacio',
  `direccion` varchar(255) DEFAULT 'vacio',
  `lat` varchar(255) NOT NULL DEFAULT '0',
  `lng` varchar(255) NOT NULL DEFAULT '0',
  `pais` varchar(255) DEFAULT 'vacio',
  `codigo` varchar(255) DEFAULT 'Sin_Asignar',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `modelo` varchar(255) NOT NULL DEFAULT '0',
  `serie` varchar(255) NOT NULL DEFAULT '0',
...
CREATE TABLE `graficar_contratos` (
  `id` int(11) NOT NULL,
  `date_at` varchar(255) DEFAULT '0',
  `val` varchar(255) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `imprimir` (
  `codigo` varchar(255) NOT NULL DEFAULT 'vacio',
  `producto` varchar(255) NOT NULL DEFAULT 'vacio',
  `precio_unitario` varchar(255) NOT NULL DEFAULT 'vacio',
  `precio_total` varchar(255) NOT NULL DEFAULT 'vacio',
  `cantidad` varchar(255) NOT NULL DEFAULT 'vacio',
  `descuento` varchar(255) NOT NULL DEFAULT '0',
  `anticipo` varchar(255) NOT NULL DEFAULT '0',
  `entrega` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `imprimir_recaudacion` (
  ...
  `caja` varchar(255) NOT NULL DEFAULT 'vacio',
  `cliente` varchar(255) NOT NULL DEFAULT 'vacio',
  `abono` varchar(255) NOT NULL DEFAULT 'vacio',
  `fecha` varchar(255) NOT NULL DEFAULT 'vacio',
  `usuario` varchar(255) NOT NULL DEFAULT 'vacio',
  `estado` varchar(255) NOT NULL DEFAULT 'vacio',
  `concepto` varchar(255) NOT NULL DEFAULT 'vacio',
  `id` varchar(255) NOT NULL DEFAULT 'vacio',
  `tipo` varchar(255) NOT NULL DEFAULT 'vacio',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `imprimir_recaudacion_ats` (
  ...
  `tipo` varchar(255) NOT NULL DEFAULT 'vacio',
  `ci` varchar(255) NOT NULL DEFAULT 'vacio',
  `subtotal` varchar(255) NOT NULL DEFAULT 'vacio',
  `iva` varchar(255) NOT NULL DEFAULT 'vacio',
  `total` varchar(255) NOT NULL DEFAULT 'vacio',
  `telefono` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`unico`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mail` varchar(255) NOT NULL DEFAULT 'sin mail',
  `contrasena` varchar(255) NOT NULL DEFAULT 'sin contrasena',
  `logo` varchar(255) NOT NULL DEFAULT 'sin logo',
  `cuentas` varchar(255) NOT NULL DEFAULT 'sin cuentas',
  `ip` varchar(255) NOT NULL DEFAULT 'http://45.225.107.57',
  `pago` varchar(255) NOT NULL DEFAULT 'vacio',
  `inicioservicio` varchar(255) NOT NULL DEFAULT 'sin_imagen',
  `finservicio` varchar(255) NOT NULL DEFAULT 'sin_imagen',
  `contrato` varchar(255) NOT NULL DEFAULT 'sin imagen',
  `nota` varchar(255) NOT NULL DEFAULT '0',
  `contrasenaapp` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `migrar` (
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `nombre` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `plan` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `valor` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
...
CREATE TABLE `mikrotik` (
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `corte` varchar(255) NOT NULL DEFAULT '0',
  `backup` varchar(255) NOT NULL DEFAULT '0',
  `creacion` varchar(255) NOT NULL DEFAULT '0',
  `usuario` varchar(255) NOT NULL DEFAULT '0',
  `reactivacion` varchar(255) NOT NULL DEFAULT '0',
  `reinicio` varchar(255) NOT NULL DEFAULT '0',
  `eliminacion` varchar(255) NOT NULL DEFAULT '0',
  `contrasena` varchar(255) NOT NULL DEFAULT '0',
  `nodo` varchar(255) NOT NULL DEFAULT 'Sin_nodo',
  UNIQUE KEY `ip` (`ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mikrotik` VALUES ('45.236.151.130','0','0','0','sistema','0','0','0','Global*2024','Biblian'),('45.236.151.150','no','Vacio','Vacio','sistema','Vacio','Vacio','Vacio','Gl0b4l@2024','Cuenca');
...
CREATE TABLE `mikrotikclientes` (
  `nombreuno` varchar(255) NOT NULL DEFAULT '0',
  `nombredos` varchar(255) NOT NULL DEFAULT '0',
  `nombretres` varchar(255) NOT NULL DEFAULT '0',
  `nombrecuatro` varchar(255) NOT NULL DEFAULT '0',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `monitoreo` (
  `id` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `dispositivo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ip` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `estado` varchar(255) NOT NULL DEFAULT 'Sin_Asignar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `multas` (
  `codigo` varchar(255) NOT NULL DEFAULT 'vacio',
  `descripcion` varchar(255) NOT NULL DEFAULT 'vacio',
  `valor` varchar(255) NOT NULL DEFAULT 'vacio',
  `id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nodo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(255) NOT NULL DEFAULT 'vacio',
  `puesto` varchar(255) NOT NULL DEFAULT 'vacio',
  `provincia` varchar(50) NOT NULL DEFAULT '0',
  `canton` varchar(50) NOT NULL DEFAULT '0',
  `parroquia` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
CREATE TABLE `olt` (
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `olt` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `vlan` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `ipinicio` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  PRIMARY KEY (`unico`)
...
CREATE TABLE `olt_conexion` (
  ...
  `reinicio` varchar(255) NOT NULL DEFAULT '0',
  `contrasena` varchar(255) NOT NULL DEFAULT '0',
  `eliminacion` varchar(255) NOT NULL DEFAULT 'No',
  `nodo` varchar(255) NOT NULL DEFAULT 'Sin_nodo',
  UNIQUE KEY `ip` (`ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oltclientes` (
  ...
  `vlan` varchar(255) NOT NULL DEFAULT '0',
  `ip` varchar(255) NOT NULL DEFAULT '0',
  `lugar` varchar(255) NOT NULL DEFAULT '0',
  `subida` varchar(255) NOT NULL DEFAULT '0',
  `bajada` varchar(255) NOT NULL DEFAULT '0',
...
CREATE TABLE `pagos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mes` varchar(255) NOT NULL DEFAULT 'vacio',
  `estado` varchar(255) NOT NULL DEFAULT 'vacio',
  `registrado` varchar(255) NOT NULL DEFAULT 'vacio',
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `peliculas` (
  `id_categoria` varchar(255) NOT NULL DEFAULT '0',
  `id_peliculas` int(11) NOT NULL,
  `nombre` varchar(255) NOT NULL DEFAULT '0',
  `descripcion` varchar(255) NOT NULL DEFAULT '0',
  `fecha` varchar(255) NOT NULL DEFAULT '0',
  `pelicula_url` varchar(255) NOT NULL DEFAULT '0',
  `portada_url` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `personal` (
  ...
  `mail` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `foto` varchar(255) NOT NULL DEFAULT '../images/personal/silueta.jpg',
  `puesto` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `idunico` int(11) NOT NULL AUTO_INCREMENT,
  `serie` varchar(255) DEFAULT 'vacio',
  `caja` varchar(255) NOT NULL DEFAULT 'vacio',
  `uno` varchar(255) NOT NULL DEFAULT 'no',
  `dos` varchar(255) NOT NULL DEFAULT 'no',
  `tres` varchar(255) NOT NULL DEFAULT 'no',
  `cuatro` varchar(255) NOT NULL DEFAULT 'no',
  `cinco` varchar(255) NOT NULL DEFAULT 'no',
  `seis` varchar(255) NOT NULL DEFAULT 'no',
  `siete` varchar(255) NOT NULL DEFAULT 'no',
  `ocho` varchar(255) NOT NULL DEFAULT 'no',
  `nueve` varchar(255) NOT NULL DEFAULT 'no',
  `diez` varchar(255) NOT NULL DEFAULT 'no',
  `once` varchar(255) NOT NULL DEFAULT 'no',
  `doce` varchar(255) NOT NULL DEFAULT 'no',
  `trece` varchar(255) NOT NULL DEFAULT 'no',
  `catorce` varchar(255) NOT NULL DEFAULT 'no',
  `quince` varchar(255) NOT NULL DEFAULT 'no',
  `diezyseis` varchar(255) NOT NULL DEFAULT 'no',
  `diezysiete` varchar(255) NOT NULL DEFAULT 'no',
  `diezyocho` varchar(255) NOT NULL DEFAULT 'no',
  `diezynueve` varchar(255) NOT NULL DEFAULT 'no',
  `veinte` varchar(255) NOT NULL DEFAULT 'no',
  `veinteyuno` varchar(255) NOT NULL DEFAULT 'no',
  `veinteydos` varchar(255) NOT NULL DEFAULT 'no',
  `veinteytres` varchar(255) NOT NULL DEFAULT 'no',
  `veinteycuatro` varchar(255) NOT NULL DEFAULT 'no',
  `veinteycinco` varchar(255) NOT NULL DEFAULT 'no',
  `veinteyseis` varchar(255) NOT NULL DEFAULT 'no',
  `veinteysiete` varchar(255) NOT NULL DEFAULT 'no',
  `veinteyocho` varchar(255) NOT NULL DEFAULT 'no',
  `veinteynueve` varchar(255) NOT NULL DEFAULT 'no',
  `treinta` varchar(255) NOT NULL DEFAULT 'no',
  `treintayuno` varchar(255) NOT NULL DEFAULT 'no',
  `treintaydos` varchar(255) NOT NULL DEFAULT 'no',
  `treintaytres` varchar(255) NOT NULL DEFAULT 'no',
  `treintaycuatro` varchar(255) NOT NULL DEFAULT 'no',
  `treintaycinco` varchar(255) NOT NULL DEFAULT 'no',
  `treintayseis` varchar(255) NOT NULL DEFAULT 'no',
  `treintaysiete` varchar(255) NOT NULL DEFAULT 'no',
  `treintayocho` varchar(255) NOT NULL DEFAULT 'no',
  `treintaynueve` varchar(255) NOT NULL DEFAULT 'no',
  `cuarenta` varchar(255) NOT NULL DEFAULT 'no',
  `cuarentayuno` varchar(255) NOT NULL DEFAULT 'no',
  `cuarentaydos` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentaytres` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentaycuatro` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentaycinco` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentayseis` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentaysiete` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentayocho` varchar(10) NOT NULL DEFAULT 'no',
  `cuarentaynueve` varchar(10) NOT NULL DEFAULT 'no',
  `cincuenta` varchar(10) NOT NULL DEFAULT 'no',
  `cincuentayuno` varchar(10) NOT NULL DEFAULT 'no',
  `cincuentaydos` varchar(10) NOT NULL DEFAULT 'no',
  `cincuentaytres` varchar(10) NOT NULL DEFAULT 'no',
  `exportar` varchar(10) NOT NULL DEFAULT 'no',
  `usuario` varchar(255) DEFAULT '0',
  `contrasena` varchar(255) NOT NULL DEFAULT '0',
  `estado` varchar(255) NOT NULL DEFAULT 'activo',
  `cambiarprecio` varchar(10) NOT NULL DEFAULT 'no',
  PRIMARY KEY (`idunico`)
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prefjo` (
  `pais` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `prefijo` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
...
CREATE TABLE `productos` (
  `id` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `serie` varchar(1000) NOT NULL DEFAULT 'Sin Asignar',
  `fechaing` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `periodo` varchar(255) NOT NULL DEFAULT 'Sin Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT '0',
  `foto` varchar(255) NOT NULL DEFAULT '../images/silueta.jpg',
  `precio` varchar(255) NOT NULL DEFAULT '0',
  `categoria` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `habitaciones` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `banos` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `autos` varchar(255) NOT NULL DEFAULT 'sin_asignar',
  `facturar` varchar(255) NOT NULL DEFAULT 'no',
  `metraje` varchar(255) NOT NULL DEFAULT '0',
  `megass` int(11) NOT NULL DEFAULT 0,
  `megasb` int(11) NOT NULL DEFAULT 0,
  `tipo` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `producto_unico` varchar(255) NOT NULL DEFAULT 'no',
  `pct` varchar(255) NOT NULL DEFAULT 'no',
  `preciouno` varchar(255) NOT NULL DEFAULT '0',
  `preciodos` varchar(255) NOT NULL DEFAULT '0',
  `preciotres` varchar(255) NOT NULL DEFAULT '0',
  `contabilidad` varchar(255) NOT NULL DEFAULT '0',
  `servicio` varchar(10) NOT NULL DEFAULT '10',
  `grabaiva` varchar(10) NOT NULL DEFAULT 'no',
  `preciocompra` varchar(255) NOT NULL DEFAULT '0',
  `linkcobro` varchar(255) NOT NULL DEFAULT '0',
  `minimo` varchar(255) NOT NULL DEFAULT '0',
  `maximo` varchar(255) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `propaganda` (
  ...
  `telefono1` varchar(255) NOT NULL DEFAULT '0',
  `mail` varchar(255) NOT NULL DEFAULT '0',
  `procesado` varchar(255) NOT NULL DEFAULT '0',
  `envio` varchar(255) NOT NULL DEFAULT '0',
  `medio` varchar(255) NOT NULL DEFAULT '0',
  `fechaprocesado` varchar(255) NOT NULL DEFAULT '0',
  `fechahoy` varchar(255) NOT NULL DEFAULT '0',
  `ciudad` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proveedores` (
  ...
  `saldo` int(11) NOT NULL DEFAULT 0,
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `isp` varchar(255) NOT NULL DEFAULT '0',
  `proveedorisp` varchar(255) NOT NULL DEFAULT '0',
  `nodo` varchar(255) NOT NULL DEFAULT 'Sin_nodo',
...
CREATE TABLE `registro` (
  ...
  `codigo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `accion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `saldo_anterior` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `saldo` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `proveedor` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `hora` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `bodega` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `seccion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `numerorecibo` varchar(255) NOT NULL DEFAULT 'Sin_Recibo',
  `serviciotecnico` varchar(255) NOT NULL DEFAULT '0',
  `observacion` varchar(255) NOT NULL DEFAULT 'vacio',
  `serie` varchar(255) NOT NULL DEFAULT 'vacio',
  `caja` varchar(255) NOT NULL DEFAULT 'vacio',
  `codigoautorizacion` varchar(255) NOT NULL DEFAULT 'sin_codigo',
  `serieproducto` varchar(255) NOT NULL DEFAULT 'Sin_serie',
  `descuento` varchar(255) NOT NULL DEFAULT '0',
  PRIMARY KEY (`unico`)
...
CREATE TABLE `registro_pagos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ruc_ci` varchar(255) NOT NULL DEFAULT 'vacio',
  `nombres` varchar(255) NOT NULL DEFAULT 'vacio',
  `direccion` varchar(255) NOT NULL DEFAULT 'vacio',
  `telefono` varchar(255) NOT NULL DEFAULT 'vacio',
  `mail` varchar(255) NOT NULL DEFAULT 'vacio',
  `image` varchar(255) NOT NULL DEFAULT 'vacio',
  `url_image` varchar(900) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `registroeliminados` (
  ...
  `unico` int(11) NOT NULL,
  `numerorecibo` varchar(255) NOT NULL DEFAULT 'Sin_Recibo',
  `serviciotecnico` int(11) NOT NULL DEFAULT 0,
  `observacion` varchar(255) NOT NULL DEFAULT 'vacio',
...
CREATE TABLE `reportes_generados` (
  ...
  `usuario_generador` varchar(100) DEFAULT 'Sistema',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reportes_generados` VALUES (1,'lopam_20260608_114056.xls','../arcotel/lopam/lopam_20260608_114056.xls','2026-06-08 11:40:56','Sistema'),(2,'lopam_20260615_101316.xls','../arcotel/lopam/lopam_20260615_101316.xls','2026-06-15 10:13:16','Sistema');
...
INSERT INTO `respaldo` VALUES (0,'optimus_global_telecom_2026-06-15_17-43-34.sql','15-06-2026 17:43:35'),(0,'optimus_global_telecom_2026-06-15_17-49-15.sql','15-06-2026 17:49:17'),(0,'optimus_global_telecom_2026-06-15_17-49-36.sql','15-06-2026 17:49:37');
...
CREATE TABLE `rolesconfiguracion` (
  `unico` int(11) NOT NULL,
  `puesto` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `salario` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `iesspatronal` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `iesspersonal` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `fondosdereserva` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `comicion` varchar(255) NOT NULL DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rolesdepago` (
  ...
  `iesspatronal` varchar(255) NOT NULL DEFAULT '0',
  `iesspersonal` varchar(255) NOT NULL DEFAULT '0',
  `fondosdereserva` varchar(255) NOT NULL DEFAULT '0',
  `personal` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `adelantos` varchar(255) NOT NULL DEFAULT '0',
  `comiciones` varchar(255) NOT NULL DEFAULT '0',
  `horasextrascomplementarias` varchar(255) NOT NULL DEFAULT '0',
  `horasextrassuplementarias` varchar(255) NOT NULL DEFAULT '0',
  `multas` varchar(255) NOT NULL DEFAULT '0',
...
CREATE TABLE `series` (
  ...
  `bodega` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `estado` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `asignado` varchar(255) NOT NULL DEFAULT 'disponible',
  `contrato` varchar(255) NOT NULL DEFAULT '0',
...
INSERT INTO `series` VALUES ('no_disponible','2025-07-07 (10:37:30)','','demo','sin_existencia','0105190631','257','sin_documento'),('fibradrop','2024-12-02 (15:46:30)','001','principalfabrica','Existencia','disponible','0',''),('fibradrop','2024-12-02 (15:46:34)','002','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:43:28)','218C030000122','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:43:35)','218C030001092','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:43:19)','218C030001421','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:42:46)','218C030003065','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:43:06)','2201227006527','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:43:43)','2204079006184','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-09-25 (16:12:50)','223C2N0004249','Grupo1','Existencia','0102917689','0',''),('MR50G','2024-11-06 (12:41:51)','2243482000633','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:35:11)','2243482000634','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:39:46)','2243482000664','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:44:49)','2243482000665','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:48:09)','2243482000673','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:37:38)','2243482000677','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:48:42)','2243482000678','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:43:07)','2243482000679','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:44:20)','2243482000680','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-06 (12:35:39)','2243482002940','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:49:16)','22460B6002087','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:49:30)','22460B6002551','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:48:19)','22460B6009288','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:48:58)','22460B6009289','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:48:05)','22460B6010036','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:48:33)','22460B6010258','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:50:05)','22460B6010520','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:48:46)','22460B6010591','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:49:54)','22460B6010692','principalfabrica','Existencia','disponible','0',''),('xz000','2025-01-15 (15:49:43)','22460B6010943','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:17:06)','2247587000134','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:16:08)','2247587002028','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:34:37)','2247587002029','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:35:07)','2247587002628','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:35:20)','2247587002937','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:15:26)','2247587003575','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:35:34)','2247587003724','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:34:53)','2247587003731','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:14:32)','2247587003732','principalfabrica','Existencia','disponible','0',''),('xz000','2024-11-07 (11:16:23)','2247587003733','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:19:05)','22483E8000934','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:19:40)','22483E8000956','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:20:04)','22483E8000957','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:18:29)','22483E8001001','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:19:52)','22483E8001003','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:19:30)','22483E8001004','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:20:15)','22483E8001006','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:19:17)','22483E8001007','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:18:52)','22483E8001083','principalfabrica','Existencia','disponible','0',''),('MR50G','2025-01-15 (16:18:40)','22483E8001084','principalfabrica','Existencia','disponible','0',''),('MR50G','2024-11-22 (11:03:11)','30:16:9D:38:CZ3A','principalfabrica','Existencia','disponible','0',''),('WR940N','2024-09-27 (16:44:54)','42204079006140','Grupo1','Existencia','0102917689','0',''),('no_disponible','2024-12-19 (18:31:24)','48575443035A229A','demo','sin_existencia','0150881431','35','sin_documento'),('no_disponible','2024-12-26 (13:22:03)','485754430379DC9A','0302227194','sin_existencia','0107516619','38','sin_documento'),('no_disponible','2024-12-26 (13:25:07)','4857544306A9ED92','0302227194','sin_existencia','0101133957','44','sin_documento'),('no_disponible','2025-10-06 (10:36:59)','48575443070BE992','demo','sin_existencia','0102917689','117','sin_documento'),('no_disponible','2025-07-07 (10:43:31)','485754431D8B0082','demo','sin_existencia','disponible','0','sin_documento'),('no_disponible','2024-12-19 (18:46:07)','48575443233126C3','demo','sin_existencia','0301068680','49','sin_documento'),('no_disponible','2024-12-19 (18:41:19)','48575443261BB592','demo','sin_existencia','0917881963','26','sin_documento'),('no_disponible','2024-12-19 (18:37:48)','48575443264664C3','demo','sin_existencia','0103797114001','48','sin_documento'),('HG8310M','2024-09-25 (10:35:45)','4857544326517292','Grupo1','Existencia','0102917689','0',''),('no_disponible','2024-12-26 (13:25:30)','4857544326795F92','0302227194','sin_existencia','0101318947','50','sin_documento'),('no_disponible','2024-12-19 (18:22:49)','4857544326AEC692','demo','sin_existencia','0101281692','46','sin_documento'),('no_disponible','2024-12-19 (18:40:59)','4857544326E8EF92','demo','sin_existencia','0602663742','42','sin_documento'),('no_disponible','2024-12-05 (15:00:42)','485754432A7DE3C3','demo','sin_existencia','1401162811','4','sin_documento'),('no_disponible','2024-12-26 (13:36:58)','485754432A7E2DC3','0302227194','sin_existencia','','','sin_documento'),('no_disponible','2024-12-19 (18:45:35)','485754432D478F9E','demo','sin_existencia','0106392541','148','sin_documento'),('no_disponible','2025-07-11 (12:17:25)','485754432E1A8BC3','demo','sin_existencia','0105706956','258','sin_documento'),('no_disponible','2024-12-05 (14:58:07)','48575443332EC69D','demo','sin_existencia','0152178703','31','sin_documento'),('no_disponible','2024-12-05 (14:56:15)','48575443732D949D','demo','sin_existencia','0105014690','21','sin_documento'),('no_disponible','2024-12-26 (13:21:44)','485754437384469D','0302227194','sin_existencia','0103486890','58','sin_documento'),('no_disponible','2024-12-19 (18:34:57)','4857544377B1259A','demo','sin_existencia','0101297281','2','sin_documento'),('no_disponible','2024-12-23 (12:16:36)','485754437814E19D','12345','sin_existencia','0150461887','66','sin_documento'),('HG8310M','2024-09-27 (15:44:48)','48575443855A6A9B','principalfabrica','Existencia','disponible','0',''),('no_disponible','2024-12-19 (18:38:07)','485754438568969B','demo','sin_existencia','0105836225','25','sin_documento'),('no_disponible','2024-12-19 (18:28:34)','4857544386372135','demo','sin_existencia','0105020929','140','sin_documento'),('no_disponible','2025-01-21 (14:42:19)','4857544389B74135','demo','sin_existencia','0107596256','127','sin_documento'),('no_disponible','2024-12-19 (18:42:35)','4857544399C0ED9B','demo','sin_existencia','0104451356','55','sin_documento'),('no_disponible','2024-12-19 (18:31:07)','48575443EFA7259C','demo','sin_existencia','0107428559','18','sin_documento'),('no_disponible','2024-12-19 (18:39:36)','54504C470051443A','demo','sin_existencia','0195102211001','149','sin_documento'),('no_disponible','2024-12-26 (13:22:45)','54504C47008FC647','0302227194','sin_existencia','0105840060','93','sin_documento'),('no_disponible','2025-07-30 (12:39:54)','54504C47008FC80C','demo','sin_existencia','0106583685','261','sin_documento'),('no_disponible','2024-12-19 (18:35:55)','54504C47008FC8A4','demo','sin_existencia','1400486633','63','sin_documento'),('no_disponible','2024-12-19 (18:37:15)','54504C47008FCA44','demo','sin_existencia','0103243051001','76','sin_documento'),('no_disponible','2024-12-19 (18:41:39)','54504C4700B9F0D4','demo','sin_existencia','','','sin_documento'),('no_disponible','2024-12-26 (13:23:03)','54504C4700B9F567','0302227194','sin_existencia','','','sin_documento'),('no_disponible','2024-12-19 (18:36:24)','54504C4700B9F5B2','demo','sin_existencia','0106948243','74','sin_documento'),('no_disponible','2024-12-19 (18:36:53)','54504C4700B9F7AF','demo','sin_existencia','0100972959','75','sin_documento'),('no_disponible','2025-11-06 (10:55:02)','54504C470C30658F','demo','sin_existencia','0104874607','273','sin_documento'),('no_disponible','2025-07-25 (09:49:14)','54504C470DC38234','demo','sin_existencia','0102917689','117','sin_documento'),('no_disponible','2024-12-31 (10:20:44)','54504C470DC384A7','demo','sin_existencia','0702619362','162','sin_documento'),('no_disponible','2024-12-13 (18:42:35)','54504C470DC3882C','demo','sin_existencia','0105692750','157','sin_documento'),('no_disponible','2024-12-17 (10:51:56)','54504C470DEC8D29','demo','sin_existencia','0102054798001','158','sin_documento'),('no_disponible','2024-12-19 (18:40:35)','54504C47210AECFD','demo','sin_existencia','0104201736','133','sin_documento'),('no_disponible','2024-12-30 (15:46:21)','54504C47210AED3F','demo','sin_existencia','0301169645','161','sin_documento'),('no_disponible','2024-12-07 (09:25:30)','54504C47210AED44','12345','sin_existencia','1400916308','156','sin_documento'),('no_disponible','2025-09-23 (12:51:46)','54504C47210AED6A','demo','sin_existencia','1400942247','172','sin_documento'),('no_disponible','2024-12-06 (11:05:38)','54504C47210AEDAB','demo','sin_existencia','1720701679','155','sin_documento'),('no_disponible','2025-01-24 (15:27:38)','54504C47216ED665','12345','sin_existencia','0104675624','164','sin_documento'),('no_disponible','2025-02-26 (09:31:26)','54504C47216EDDCC','demo','sin_existencia','1311829277','168','sin_documento'),('no_disponible','2025-01-31 (11:46:59)','54504C47216EE023','12345','sin_existencia','0100837137','167','sin_documento'),('no_disponible','2025-03-21 (10:25:26)','54504C47216EE158','demo','sin_existencia','disponible','0','sin_documento'),('no_disponible','2025-03-06 (11:38:52)','54504C47216EE472','12345','sin_existencia','0104562335','171','sin_documento'),('no_disponible','2025-08-05 (11:55:19)','54504C477914CEC9','demo','sin_existencia','0105092290','262','sin_documento'),('no_disponible','2025-07-30 (10:27:26)','54504C477914D06F','demo','sin_existencia','0102917689','117','sin_documento'),('no_disponible','2024-12-05 (14:50:09)','54504C478447C792','demo','sin_existencia','0104698881','104','sin_documento'),('no_disponible','2024-11-22 (10:29:35)','54504C478447CF73','demo','sin_existencia','disponible','0','sin_documento'),('no_disponible','2025-04-02 (13:28:47)','54504C4784719CD0','demo','sin_existencia','0914636006','141','sin_documento'),('no_disponible','2025-02-28 (10:30:24)','54504C478471A099','12345','sin_existencia','0105857361','169','sin_documento'),('no_disponible','2024-12-19 (18:30:35)','54504C478B1F3383','demo','sin_existencia','0106485469','102','sin_documento'),('no_disponible','2024-12-26 (13:22:26)','54504C478BF311EB','0302227194','sin_existencia','0105530828','41','sin_documento'),('no_disponible','2025-07-25 (09:59:02)','54504C478BF3140B','demo','sin_existencia','0102917689','117','sin_documento'),('no_disponible','2024-12-26 (13:38:17)','54504C478BF314F1','0302227194','sin_existencia','','','sin_documento'),('no_disponible','2025-09-23 (11:52:09)','54504C478BF31766','demo','sin_existencia','0909217093','68','sin_documento'),('no_disponible','2024-12-19 (18:42:09)','54504C47CE7535D3','demo','sin_existencia','','','sin_documento'),('no_disponible','2024-12-19 (18:45:09)','54504C47CE753A62','demo','sin_existencia','0101577054','106','sin_documento'),('no_disponible','2024-12-19 (18:30:12)','54504C47D01C0965','demo','sin_existencia','0101297281','1','sin_documento'),('no_disponible','2024-12-26 (13:30:34)','54504C47D01C0AFB','0302227194','sin_existencia','0105143523','101','sin_documento'),('no_disponible','2024-12-26 (13:24:48)','54504C47D01C0B7F','0302227194','sin_existencia','0103665188','17','sin_documento'),('no_disponible','2024-12-19 (18:28:07)','54504C47D01C0BB5','demo','sin_existencia','0105656888','100','sin_documento'),('plan3des','2024-10-10 (11:45:40)','Sin_Serie','Grupo1','Existencia','0103797114001','48','0');
...
CREATE TABLE `servicio_alta_nuevo` (
  `unico` int(11) NOT NULL,
  `fecha` varchar(255) NOT NULL DEFAULT 'vacio',
  `olt` varchar(255) NOT NULL DEFAULT 'vacio',
  `puerto` int(11) NOT NULL DEFAULT 0,
  `vlan` int(11) NOT NULL DEFAULT 0,
  `ipgestion` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `cliente` varchar(255) NOT NULL DEFAULT 'vacio',
  `pon` varchar(255) NOT NULL DEFAULT 'vacio',
  `potencia` varchar(255) NOT NULL DEFAULT '0',
  `problema` varchar(255) NOT NULL DEFAULT 'vacio',
  `usuario` varchar(255) NOT NULL DEFAULT 'vacio',
  `numerocliente` int(11) NOT NULL DEFAULT 0,
  `puerto2` int(11) NOT NULL DEFAULT 0,
  `megas` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servicio_tecnico_oficina` (
  ...
  `fecha` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `cliente` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `pon` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `potencia` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `detalle` varchar(255) NOT NULL DEFAULT 'Sin_asignar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `serviciotecnico` (
  ...
  `foto4` varchar(255) NOT NULL DEFAULT '../images/silueta.gif',
  `cliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `pagado` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `ip` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `router` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `bobina` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `plan` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `longitud` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `latitud` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `potencia` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `pon` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `descripcion` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `personal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `tecnico1` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `tecnico2` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `tecnico3` varchar(255) NOT NULL DEFAULT 'sin_asignar',
  `tecnico4` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `factura` varchar(255) NOT NULL DEFAULT 'Sin_asignar',
  `unico` int(11) NOT NULL AUTO_INCREMENT,
  `observacion` varchar(1000) NOT NULL DEFAULT 'vacio',
  `motivo` varchar(255) NOT NULL DEFAULT 'vacio',
  `nodo` varchar(255) NOT NULL DEFAULT 'Sin_nodo',
  PRIMARY KEY (`unico`)
...
CREATE TABLE `solicitud_peliculas` (
  ...
  `id_usuario` varchar(255) NOT NULL DEFAULT 'vacio',
  `nombre_pelicula` varchar(255) NOT NULL DEFAULT 'vacio',
  `solicitud` varchar(255) NOT NULL DEFAULT 'vacio'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sulicitudproducto` (
  ...
  `extra` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `bodegadestino` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `serie` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
...
CREATE TABLE `task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT 'vacio',
  `description` varchar(900) DEFAULT 'vacio',
  `created_at` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `personal` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `usuario` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  ...
  `producto` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `serie` varchar(255) NOT NULL DEFAULT '0',
  `destino` varchar(255) NOT NULL DEFAULT 'vacio',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipoproducto` (
  ...
  `codigo` varchar(255) NOT NULL DEFAULT 'vacio',
  `puesto` varchar(255) NOT NULL DEFAULT 'vacio',
  `serviciotecnico` varchar(255) NOT NULL DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ventas` (
  ...
  `abono` varchar(255) NOT NULL DEFAULT '0',
  `nombrecliente` varchar(255) NOT NULL DEFAULT 'Sin_Asignar',
  `recibo` varchar(255) NOT NULL DEFAULT '../images/sistema/sin_documento.png',
  `numerorecibo` varchar(255) NOT NULL DEFAULT 'Sin_Recibo',
  `contrato` varchar(255) NOT NULL DEFAULT '0',
  `tipodocumento` varchar(255) NOT NULL DEFAULT 'Sin_documento',
  `foto` varchar(255) NOT NULL DEFAULT 'Sin_Foto',
  ...
  `anticipo` varchar(255) NOT NULL DEFAULT '0',
  `entrega` varchar(255) NOT NULL DEFAULT '0',
  `descripcion` varchar(255) NOT NULL DEFAULT 'Sin_Descripcion',
  `serie` varchar(255) NOT NULL DEFAULT '001',
  `caja` varchar(255) NOT NULL DEFAULT '001',
  `nodo` varchar(255) NOT NULL DEFAULT 'Cuenca',
  PRIMARY KEY (`numero`)
) ENGINE=InnoDB AUTO_INCREMENT=1325 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ventas` VALUES ('1',1318,'2026-04-23 (16:14:49)','1','1','1','0102917689','Plan2','1','17.39','17.39','17.39','2.61','20.00','1','1','cancelado','Sin_Asignar','20','Daiel Teodoro Cardenas Campos','../images/sistema/sin_documento.png','Sin_Recibo','0','factura','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','001','001','CUENCA'),('1319',1319,'2026-05-01(04:17:30)','1','1','1','0102917689','Plan2','1','17.39','17.39','17.39','2.61','20.00','1','1','cancelado','Sin_Asignar','20','Daiel Teodoro Cardenas Campos','../images/sistema/sin_documento.png','Sin_Recibo','0','factura','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','001','001','CUENCA'),('1320',1320,'2026-03-24 (09:18:21)','1','1','1','0102917689','Plan5','1','30.44','30.44','30.44','4.57','35.01','1','1','Incobrable','Sin_Asignar','0','Daiel Teodoro Cardenas Campos','../images/sistema/sin_documento.png','Sin_Recibo','1','Sin_documento','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','1','1','CUENCA'),('1321',1321,'2026-05-01 (23:06:35)','1','1','1','0102917689','Plan2','1','17.39','17.39','17.39','2.61','20.00','1','1','anular','Sin_Asignar','0','Daiel Teodoro Cardenas Campos','../images/sistema/sin_documento.png','Sin_Recibo','0','Sin_documento','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','001','001','Cuenca'),('1322',1322,'2026-04-01(02:22:10)','1','1','1','0102917689','Plan5','1','30.44','30.44','30.44','4.57','35.01','1','1','cancelado','Sin_Asignar','35.01','CARDENAS CAMPOS DANIEL TEODORO Sin Asignar','../clientes/fotos/0102917689/global net.jpg','Sin_Recibo','1','factura','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','001','001','CUENCA'),('1323',1323,'2026-05-01(09:29:07)','1','1','1','0102917689','Plan5','1','30.44','30.44','30.44','4.57','35.01','1','1','Incobrable','Sin_Asignar','0','CARDENAS CAMPOS DANIEL TEODORO Sin Asignar','../images/sistema/sin_documento.png','Sin_Recibo','1','Sin_documento','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','1','1','CUENCA'),('1324',1324,'2026-06-01(08:09:39)','1','1','1','0102917689','Plan5','1','30.44','30.44','30.44','4.57','35.01','1','1','cancelado','Sin_Asignar','35.01','CARDENAS CAMPOS DANIEL TEODORO Sin Asignar','../clientes/fotos/0102917689/Screenshot 2026-04-09 133148.png','Sin_Recibo','1','nota','Sin_Foto','Sin_Asignar','activo','0','0','Sin_Descripcion','001','001','CUENCA');
...
-- Dump completed on 2026-06-15 17:50:04
