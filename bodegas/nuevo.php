...
if (isset($_GET['codigo'])) {
   			$codigo=$_GET['codigo'];
			$sql = "SELECT * from `".$tabla."` WHERE `numero` LIKE '$codigo'";
        ...
        <div class="clientes-header-top">
            ...
            <div>
                ...
                <p class="clientes-subtitle">
                    Administración de datos de Bodega
                </p>
            ...
            <td align="center">
              ...
              <div class="grilla_listado">
                <div class="panel-dark">
                  ...
                  <table width="95%" class="table-dark">
                    <tbody>
                      <tr>
                        <td><p>&nbsp;</p>
                          <p><strong>CODIGO ID :</strong></p></td>
                        </tr>
                      <tr>
                        <td><input id="element_1" name="element_1" required  class="clientes-input" type="text" maxlength="255" value="<?php echo $codigo;?>"/></td>
                        </tr>
                      <tr>
                        <td><strong>NOMBRE DE BODEGA: </strong></td>
                        </tr>
                      <tr>
                        <td><input id="element_2" name="element_2" required  class="clientes-input" type="text" maxlength="255" value="<?php echo $producto;?>"/></td>
                        </tr>
                      <tr>
                        <td><strong>RESPONSABLE:</strong></td>
                        </tr>
                      <tr>
                        <td ><select name="responsable" id="responsable" class="clientes-input">
                          <?php 
				
			 while($crowp = mysqli_fetch_assoc($result2))
 			{	
		 		if($responsable == $crowp['responsable'])
							{
						
						?>
                          <option selected value=<?php echo $codigo = $crowp['codigo'];?>><?php echo $producto = $crowp['nombres']." ".$crowp['apellidos']; ?></option>
                          <?php
							}
		 	else
							{
							?>
                          <option value=<?php echo $codigo = $crowp['codigo'];?>><?php echo $producto = $crowp['nombres']." ".$crowp['apellidos']; ?></option>
                          <?php
							}
						}
			 ...
			 ?>
                      ...
                      <tr>
                        <td><select name="principal" id="principal" class="clientes-input">
                          <option value="no">No</option>
                          <option value="si">Si</option>
                          </select></td>
                        </tr>
                      <tr>
                        <td ><input id="accion" name="accion" class="element text small" type="text" maxlength="255" value="<?php echo $accion;?>" style="visibility:hidden"/></td>
                        </tr>
                      <tr>
                        <td ><p class="buttons">
                          <input class="boton-azul" name="Guardar" type="submit" id="Guardar" title="Guardar" value="Guardar">
							
                          </p>
                          <p class="buttons">&nbsp;</p></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
