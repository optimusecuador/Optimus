...
<div class="panel-dark">
    <h3>CLIENTES CON FACTURAS PENDIENTES</h3>
    <table id="tabla" class="table-dark">
        <thead>
            <tr>
                <th>Código</th><th>Cliente</th><th>Facturas</th><th>Total</th><th>WhatsApp</th>
            </tr>
        </thead>
        <tbody>
            <?php
            while($r = mysqli_fetch_assoc($res)){
                ...
                if($tel != ""){
                    echo "<td><a class='boton-azul' target='_blank' href='https://wa.me/".$tel."?text=".$msg."'>Enviar WhatsApp</a></td>";
                } else {
                    echo "<td><button class='btn btn-secondary btn-sm' disabled>Sin teléfono</button></td>";
                }
                echo "</tr>";
            }
            ?>
