...
.menu-section a:hover{transform:translateX(6px);background:rgba(0,255,255,.08)}
	...
	<div>
    <h2 style='color:white'>ASIGNACION DE IP MIKROTIK</h2>
</div>
	<?php
/* ==========================================
...
if(isset($_POST['asignar_contrato'])){
    ...
    $contrato=mysqli_real_escape_string($con,$_POST['codigo_cliente2']);

    $sqlUpdate="
        UPDATE contratos
        SET ip='$ip2'
        WHERE nombres='$contrato'
        LIMIT 1
    ";
    ...
    <script>
        ...
        window.location.href='../menu_principal/panel.php';
...
<td>
<input
name="ip" type="text" class="clientes-input-small"
placeholder="IP"
...
<td>
<input
name="cliente" type="text" class="clientes-input-small"
id="cliente"
...
<td>
<button class="boton-azul" type="button" onclick="irNuevoContrato()">
Nuevo Contrato
</button>
</td>
...
<input
name="ip2"
type="text" class="clientes-input-small"
id="ip2"
placeholder="IP"
style="width:150px;margin-right:10px;"
value="<?php echo htmlspecialchars($ip); ?>">
...
<td>
<input
name="cliente2" type="text" class="clientes-input-small"
id="cliente2"
...
<input type="hidden" id="codigo_cliente2" name="codigo_cliente2">
</td>

<td>
<button class="boton-azul" type="submit" name="asignar_contrato">
Asignar Contrato
</button>
</td>
...
function irNuevoContrato(){
    ...
    window.location.href="../contratos/nuevo.php?nombres="+encodeURIComponent(codigo)+"&id=nuevo";
}
...
function capturarCodigo2(){
    ...
    if(valor.includes("|")){
        ...
        document.getElementById("codigo_cliente2").value=partes[0].trim();
    }
}
...
function irNuevoContrato2(){

    let codigo=document.getElementById("codigo_cliente2").value;
