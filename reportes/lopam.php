...
<div>
    <h2 style='color:white'>REPORTE LOPAM</h2>
</div>
<?php
...
<table width="100%">
  <tbody>
    <tr>
      <td align="center">
		<table width="30%" align="center" class="tabla-comic">
    <tr>
        <th colspan="2" align="center">ABONADOS CON BENEFICIO POR LA LOPAM</th>
    </tr>
    <tr>
        <th align="center">PROVINCIA</th>
        <th align="center">NÚMERO DE ABONADOS LOPAM</th>
    </tr>
    <tr>
...
<form method="GET">
    <button type="submit" name="exportar" class="boton-azul" >
        Descargar Excel
    </button>
	
</form>
		  <br>
		  <button class="boton-azul" onclick="window.open('https://apc.arcotel.gob.ec/sietel1/index.aspx','_blank')">
    Login SIETEL
</button>
		</td>
    </tr>
