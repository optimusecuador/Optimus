...
.menu-section a:hover{transform:translateX(6px);background:rgba(0,255,255,.08)}
	...
	?>
      <table width="90%"  align="center">
        <tbody>
          <tr>
            <td><br>
              <h2>IMPRIMIR <?php echo $texto = strtoupper($_SESSION['accioni']) ;?><br>
              </h2></td>
          </tr>
          <tr>
            <td><table width="100%">
              <tbody>
                <tr>
                  <td width="25" colspan="2"><img src=<?php echo $logo;?> width="128" alt=""/></td>
                  <td width="25" colspan="3"><h1>&nbsp;</h1></td>
                  <td width="25" colspan="3"><img src=<?php echo $logo;?> width="128" alt=""/></td>
                  <td width="25" colspan="3">&nbsp;</td>
                </tr>
                <tr>
                  <td align="left">Fecha</td>
                  <td colspan="4" align="left">:<?php echo $fecha = date("Y-m-d (H:i:s)", time()); ?></td>
	...
	?>
                <tr>
                  <td><?php echo $cliente = $crowp['cantidad']; $descripcionegreso = $descripcionegreso."/".$crowp['description'];?></td>
                  <td><?php 
		  ...
		  ?></td>
                ...
                <tr>
                  <td colspan="2" align="left"><p>Destino: <?php echo  $crowp['destino'];?></p>
                    <p>Serie:
                   <?php echo  $crowp['serie'];?></p></td>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td colspan="3" align="left"><p>Destino: <?php echo  $crowp['destino'];?></p>
                    <p>Serie: 
                   <?php echo $crowp['serie'];?></p></td>
                  <td align="right">&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td colspan="2"><?php echo $descripcionegreso;?></td>
                  <td align="right">&nbsp;</td>
                  <td>.</td>
                  <td>&nbsp;</td>
                  <td colspan="3">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="3" align="center">f) Responsable</td>
      ...
      <p>&nbsp;</p>
<?php mysqli_query($con, "TRUNCATE TABLE task");?>
