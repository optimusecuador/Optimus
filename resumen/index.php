...
<body>
  ...
  <nav class="main-nav">
    <details class="menu-section">
      ...
      <a href="index.php"><i data-lucide="home"></i> Resumen</a>
...
<div class="isp-dashboard">
    ...
    <div class="isp-cards">
		...
		<div class="isp-card isp-badge" onclick="window.location.href='../mikrotik/listado.php';"
     ...
     onclick="window.location.href='../servidor/index.php';"
     style="cursor:pointer;">
            <div class="isp-card-title">Servidor</div>
