...
async function playMainMovie() {
    ...
    // Parámetros modificados para forzar 720p (ancho máximo 1280), 
    // ancho de banda de video a 1.5 Mbps (1500000) y audio a 1500 kbps (1500000 bps)
