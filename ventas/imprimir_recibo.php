...
<table width="100%">
  <tbody>
    ...
    <tr>
      ...
      <td colspan="4" align="left">:<?php $ci = $_SESSION['cliente']; $cibusqueda = $_SESSION['cliente'];
    ...
    <tr>
      <td>
		...
		<?php 
		  ...
		  //{
		  $id;
		  $sql3 = "SELECT * from ventas WHERE (`id` LIKE '$id') AND (`cliente` LIKE '$cibusqueda') order by numero ASC";
      ...
      <td><?php 
			...
			$sql38 = "SELECT * from productos WHERE `producto` LIKE '$producto'";
			$result38 = mysqli_query($con, $sql38); 
			while($crow38 = mysqli_fetch_assoc($result38))
            {
				$tipo = $crow38['periodo'];
				echo $productoimprimir = $crow38['producto']."<br>";
			}
      ...
      <td>
		 ...
		 // {
		  $sql3 = "SELECT * from ventas WHERE (`id` LIKE '$id') AND (`cliente` LIKE '$cibusqueda') order by numero ASC";
			...
			while($crow3 = mysqli_fetch_assoc($result3))
            {
				 $preciounitario = $crow3['preciounitario'];
				 echo $format_number3 = number_format($preciounitario, 2)."<br>";
				//$subtotal2 = ((int)$subtotal2) + ((int)$preciounitario);
				 //$subtotal2 = $subtotal2 + $preciounitario;
			}
		  //}
		  //else
		  //{
      ...
      <td colspan="2">
		  ...
		  $sql3 = "SELECT * from ventas WHERE (`id` LIKE '$id') AND (`cliente` LIKE '$cibusqueda') order by numero ASC";
			...
			while($crow3 = mysqli_fetch_assoc($result3))
            {
				...
				$iva = $crow3['iva'];
				$subtotalindividual = $crow3['preciounitario']*$crow3['cantidad'];
				echo $format_number3 = number_format($subtotalindividual, 2)."<br>";
				$subtotal2 = $subtotal2 + $crow3['preciototal'];
    ...
    <tr>
      <td colspan="2" align="center"><?php echo $leyendafactura;?></td>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><?php echo $format_number3 = number_format($subtotal2, 2); //echo $_SESSION['subtotal'];?></td>
      <td>&nbsp;</td>
      <td colspan="3">&nbsp;</td>
      <td align="right">Subtotal:</td>
      <td><?php echo $format_number3 = number_format($subtotal2, 2); //echo $_SESSION['subtotal'];?></td>
    ...
    <tr>
      <td colspan="2">&nbsp;</td>
      <td align="right">Iva 15%:</td>
      <td><?php 
		  
		  //if($tipofactura == "normal")
		  //{
		  	  //$iva = $subtotal2 * $iva; 
		  echo $format_number3 = number_format($iva, 2);
    ...
    <tr>
      ...
      <td>
		  ...
		  if($tipofactura == "normal")
		  {
		  $total = $subtotal2 + $iva ;echo $format_number3 = number_format($total, 2); 
		  }
		  else
		  {
		  $total = $subtotal2 + $iva ;echo $format_number3 = number_format($total, 2); //echo $_SESSION['total'];
...
$err = curl_error($curl);
	...
	<?php /*?><a href="../clientes/confirmacion_activar.php?numero=<?php echo $numero; ?>">...</a><?php */?>
