...
//-- buescar en regidstro numero de factura
		//$sqlr = "SELECT * from `registro` WHERE `id` LIKE '$codigo' order by fecha DESC";
//		$resultr = mysqli_query($con, $sqlr); 
//		while($crowr = mysqli_fetch_assoc($resultr))
//            			
//					{
//						$numerofactura = $crowr['codigo'];
//						$pagado = $crowr['saldo'];
//						$usuario = $crowr['usuario'];
//						
//					}
//--buscar en ventas los datos de la venta
			$sql = "SELECT * from `".$tabla."` WHERE `id` LIKE '$codigo' AND `cliente` LIKE '$clienteb' order by fecha DESC";
...
?>
    ...
    <h2 class="clientes-form-title" id="optimus">DOCUMENTO INCOBRABLE PROCESAR</h2>
    
    <form action="confirmacion_incobrable.php" method="post" name="form1" id="form1">
        <div class="clientes-form-grid">
            
            <div class="clientes-field">
                <label for="factura">REGISTRO NUMERO</label>
                <input name="factura" type="text" required class="clientes-input" id="factura" value="<?php echo $numerofactura;?>" maxlength="255"/>
            </div>

            <div class="clientes-field">
                <label for="cliente">CEDULA</label>
                <input name="cliente" type="text" id="cliente" value="<?php echo $cliente;?>" readonly="readonly" class="clientes-input">
            </div>

            <div class="clientes-field clientes-full">
                <label for="element_2">NOMBRE</label>
            ...
            <div class="clientes-field">
                ...
                <input id="precio" name="precio" class="clientes-input" type="text" value="<?php echo $total;?>" readonly="readonly"/>
            </div>

            <div class="clientes-field">
                <label for="saldo">SALDO</label>
                <input id="saldo" name="saldo" class="clientes-input" type="text" value="<?php echo $total-$abono;?>" readonly="readonly"/>
            </div>
            ...
            <div class="clientes-field">
                ...
                <select name="institucion" id="institucion" class="clientes-input">
                    <?php while($crowc = mysqli_fetch_assoc($result2)) {
                        $selected = ($usuario == $crowc['responsable']) ? "selected" : "";
            ...
            <div class="clientes-field">
                <label for="valor">VALOR A CANCELADO</label>
                <input name="valor" type="text" required id="valor" value="<?php echo $pagado;?>" class="clientes-input">
            </div>

            <div class="clientes-field clientes-full">
                <label for="numerorecibo">MOTIVO DE LA CANCELACION</label>
                <input name="numerorecibo" type="text" class="clientes-input" id="numerorecibo" placeholder="Ingrese el Motivo">
            </div>
        ...
        <input type="hidden" name="codigoventa" value="<?php echo $codigoventa;?>" />
