...
CREATE TABLE `bodegabahia` (
  ...
  `producto` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `serie` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `fechaing` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `codigo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `periodo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `cantidad` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `foto` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `precio` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar',
  `categoria` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sin_Asignar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `respaldo` VALUES (1,'optimus_global_telecom_2026-06-15_17-43-34.sql','15-06-2026 17:43:35'),(2,'optimus_global_telecom_2026-06-15_17-49-15.sql','15-06-2026 17:49:17'),(3,'optimus_global_telecom_2026-06-15_17-49-36.sql','15-06-2026 17:49:37'),(4,'optimus_global_telecom_2026-06-15_17-50-02.sql','15-06-2026 17:50:04');
...
-- Dump completed on 2026-06-24 17:23:50
