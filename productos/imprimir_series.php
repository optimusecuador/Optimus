...
while($crowe = mysqli_fetch_assoc($resulte))
	...
	$asignado = "disponible";
	 ...
	 {
		$bodega=$_GET['codigo'];
		$sql3 = "SELECT * from `".$tabla3."` WHERE (`asignado` LIKE '$asignado') and (`bodega` LIKE '$bodega')order by fecha";
	 }
		if (isset($_GET['producto'])) 
	 {
		$producto=$_GET['producto'];
		$bodega=$_GET['bodegabuscar'];
		$sql3 = "SELECT * from `".$tabla3."` WHERE (`asignado` LIKE '$asignado') and (`producto` LIKE '$producto') and (`bodega` LIKE '$bodega')order by fecha";
	 }
		if (isset($_GET['productog'])) 
	 {
		$producto=$_GET['productog'];
		$bodega = "GENERAL";
		$sql3 = "SELECT * from `".$tabla3."` WHERE `producto` LIKE '$producto' order by fecha";
	 }
          ...
          <tr>
            <td align="center"><br>
              <div class="esquinas_redondeadas">
                <h2 id="optimus" class="clientes-title">SERIES DISPONIBLES</h2>
				 <p><?php if ($puesto_personal =="admin" OR $exportar == "si")
	{ ?><button id="btnExportar" class="btn-action btn-general" style="padding: 5px 10px; font-size: 11px;">Hoja de Calculo</button><button id="btnExportar" class="btn-action btn-contrato" style="padding: 5px 10px; font-size: 11px;">Acrobat Reader</button><button id="btnExportar" class="btn-action btn-edit" style="padding: 5px 10px; font-size: 11px;">Reporte Administrador</button><?php }?></p>
              </div></td>
          </tr>
          <tr>
            <td align="center">
              <table width="95%" align="center" class="table-dark">
                <tbody>
                  <tr>
                    <td align="center"><form action="../bodegas/kardex2.php?codigo=<?php echo $_SESSION['bodegaregresar'];?>" method="post" name="form2" id="form3">
                      <input type="image" src="../images/icons/regresar.png" name="nombre_opcional2">
                      <input name="producto2" type="hidden" id="producto2" value="<?php echo $_SESSION['bodegaregresar'];?>">
                      </form></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div class="panel-dark">
                  <table width="95%" align="center" class="table-dark">
                    <tbody>
                      ...
                      <tr>
                        <td align="center"><?php echo $bodega;?></td>
              ...
              <p>&nbsp;</p>
                <div class="panel-dark">
                  <table width="95%" align="center" class="table-dark" id="tabla">
                    <tbody>
                      <tr>
                        <td width="25"><strong>Cant</strong></td>
                        <td width="25"><strong>Producto</strong></td>
                        <td width="25"><strong>Serie</strong></td>
                        <td width="25"><strong>Bodega</strong></td>
	...
	?>
		...
		?></td>
                        <td><?php echo  $crowp['serie'];?></td>
                        <td><?php 
		
		$tabla = "bodegas";
		$producto = $crowp['bodega'];
		...
		?></td>
                        <td colspan="2"><a href="../productos/historial_series.php?codigo=<?php echo $crowp['serie'];;?>" class="btn-action btn-general" style="padding: 5px 10px; font-size: 11px;"> Historial </a></td>
                        </tr>
                      <?php }?>
                      <tr>
                        <td colspan="2">&nbsp;</td>
              ...
              <a href="../bodegas/productos.php">             ...</a></td>
          </tr>
        </tbody>
    </table>
      <p>&nbsp;</p>
